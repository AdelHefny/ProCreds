...
function LogoExportar() {
  return (
    <svg
      ...
      className="fill-secant2 w-10 h-10 sm:w-12 sm:h-12 anim"
    >
...
export default function Loading() {
  return (
    <section className="h-screen w-screen fixed top-0 left-0 bg-main flex items-center justify-center z-50">
      <LogoExportar />
    </section>
  );
}
